...
Try {
	...
	[string]$appName = 'OpenVPN Connect'
	[string]$appVersion = '3.3.5'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '03/16/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		## Show Welcome Message, close OpenVPN Connect if required, verify there is enough disk space to complete the install, and persist the prompt
		Show-InstallationWelcome -CloseApps 'OpenVPNConnect' -CheckDiskSpace -PersistPrompt
		...
		$exitCode = Execute-MSI -Action 'Install' -Path "$dirFiles\openvpn-connect-3.3.5.2717_signed.msi" -Parameters 'REBOOT=ReallySuppress /QN'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message, close OpenVPN Connect with a 60 second countdown before automatically closing
		Show-InstallationWelcome -CloseApps 'OpenVPNConnect' -CloseAppsCountdown 60
		...
		$exitCode = Execute-MSI -Action 'Uninstall' -Path "{FCE2F2FA-0F09-4F66-B561-5132946B4AC4}"
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUUDxefs1Dkg7CuAEUZq+Xg+Lp
# Gi2gghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFH2pzIHz6OZ5mV1k5bg5mimkOLM+MA0GCSqGSIb3DQEBAQUABIIBgEuL8cn/
# /F/hRtTDtq0JYdLm3fMagVNNcbKDi+pa4sY85B6oxlVMoBNx3knjAzWdqCgndKwS
# mCYD30MPmxg55jmGYGqjLtz23rvdAN6D9pY2uzuL96eAO6seGTf3HbUCqXXdGW/c
# +9OsNXURw+W/gGLsM35gmeBXPbKcZlq2HHlSELK6+CIhoxiamfprKpKqzV+qz001
# TFmb6gRS/v6HUrz6cDFRioyTrlAD0y1zmbuE7RQngO08+AC257lT/TkVg9U2pMm+
# VJNMH2HGsbSHiAuC4h27DKmnzHXKWA+Xb1XpKuuVoQVxpv19BZuSOzO6Y4/IdykV
# ABizTPAWRi31BKBk5NHVE9kqDjBcpmksTaPY7+O55X7oRQzH6Jv8KPv0HdfKJW56
# 9Fn4nOIpm93FRJ5gB3i7/oA1fC3SQHWWMljTbSmNNij51aqefLIbeQj0PDTz+TzF
# 27PVa8nfokEy8CCsBSBG/g1gSG8tK7E4pXOp18hKm36ZYJO30KXVFa6O5w==
